...
class AccountRequest implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['transaction_from'] === null) {
            $invalidProperties[] = "'transaction_from' can't be null";
        }
        if ($this->container['transaction_to'] === null) {
            $invalidProperties[] = "'transaction_to' can't be null";
        }
