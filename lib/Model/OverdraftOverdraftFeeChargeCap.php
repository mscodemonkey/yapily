...
class OverdraftOverdraftFeeChargeCap implements ModelInterface, ArrayAccess
{
    ...
    protected static $setters = [
        ...
        'fee_min_max_type' => 'setFeeMinMaxType',
        'fee_type' => 'setFeeType',
        'notes' => 'setNotes',
    ...
    protected static $getters = [
        ...
        'fee_min_max_type' => 'getFeeMinMaxType',
        'fee_type' => 'getFeeType',
        'notes' => 'getNotes',
    ...
    const FEE_MIN_MAX_TYPE_MINIMUM = 'Minimum';
    const FEE_MIN_MAX_TYPE_MAXIMUM = 'Maximum';
     ...
     * @return string[]
     */
    public function getFeeMinMaxTypeAllowableValues()
    {
        return [
            self::FEE_MIN_MAX_TYPE_MINIMUM,
            self::FEE_MIN_MAX_TYPE_MAXIMUM,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['fee_min_max_type'] = isset($data['fee_min_max_type']) ? $data['fee_min_max_type'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getFeeMinMaxTypeAllowableValues();
        if (!is_null($this->container['fee_min_max_type']) && !in_array($this->container['fee_min_max_type'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'fee_min_max_type', must be one of '%s'",
                implode("', '", $allowedValues)
            );
        }
    ...
    /**
     * Gets fee_min_max_type
     *
     * @return string
     */
    public function getFeeMinMaxType()
    {
        return $this->container['fee_min_max_type'];
    }

    /**
     * Sets fee_min_max_type
     *
     * @param string $fee_min_max_type fee_min_max_type
     *
     * @return $this
     */
    public function setFeeMinMaxType($fee_min_max_type)
    {
        $allowedValues = $this->getFeeMinMaxTypeAllowableValues();
        if (!is_null($fee_min_max_type) && !in_array($fee_min_max_type, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'fee_min_max_type', must be one of '%s'",
                    implode("', '", $allowedValues)
        ...
        $this->container['fee_min_max_type'] = $fee_min_max_type;
