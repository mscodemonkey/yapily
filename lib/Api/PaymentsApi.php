...
class PaymentsApi
{
    ...
    /**
     * Operation createPaymentInitiationUsingPOST
     *
     ...
     */
    public function createPaymentInitiationUsingPOST($payment_auth_request)
    {
        list($response) = $this->createPaymentInitiationUsingPOSTWithHttpInfo($payment_auth_request);
        return $response;
    }

    /**
     * Operation createPaymentInitiationUsingPOSTWithHttpInfo
     *
     * Initiate a new single payment for user to authorise
     *
     * @param  \Yapily\Model\SortCodePaymentAuthRequest $payment_auth_request paymentAuthRequest (required)
     ...
     */
    public function createPaymentInitiationUsingPOSTWithHttpInfo($payment_auth_request)
    {
        $returnType = '\Yapily\Model\ApiResponseOfAuthorisationRequestResponse';
        $request = $this->createPaymentInitiationUsingPOSTRequest($payment_auth_request);
    ...
    /**
     * Operation createPaymentInitiationUsingPOSTAsync
     *
     * Initiate a new single payment for user to authorise
     *
     * @param  \Yapily\Model\SortCodePaymentAuthRequest $payment_auth_request paymentAuthRequest (required)
     ...
     */
    public function createPaymentInitiationUsingPOSTAsync($payment_auth_request)
    {
        return $this->createPaymentInitiationUsingPOSTAsyncWithHttpInfo($payment_auth_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation createPaymentInitiationUsingPOSTAsyncWithHttpInfo
     *
     * Initiate a new single payment for user to authorise
     *
     * @param  \Yapily\Model\SortCodePaymentAuthRequest $payment_auth_request paymentAuthRequest (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createPaymentInitiationUsingPOSTAsyncWithHttpInfo($payment_auth_request)
    {
        $returnType = '\Yapily\Model\ApiResponseOfAuthorisationRequestResponse';
        $request = $this->createPaymentInitiationUsingPOSTRequest($payment_auth_request);
    ...
    /**
     * Create request for operation 'createPaymentInitiationUsingPOST'
     *
     * @param  \Yapily\Model\SortCodePaymentAuthRequest $payment_auth_request paymentAuthRequest (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function createPaymentInitiationUsingPOSTRequest($payment_auth_request)
    {
        ...
        if ($payment_auth_request === null || (is_array($payment_auth_request) && count($payment_auth_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $payment_auth_request when calling createPaymentInitiationUsingPOST'
            );
        }
