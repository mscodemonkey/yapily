...
class PaymentsApi
{
     ...
     * @return \Yapily\Model\ApiResponseOfPaymentAuthorisationRequestResponse
     */
     ...
     * @throws \Yapily\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Yapily\Model\ApiResponseOfPaymentAuthorisationRequestResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createPaymentAuthorisationUsingPOSTWithHttpInfo($payment_auth_request)
    {
        $returnType = '\Yapily\Model\ApiResponseOfPaymentAuthorisationRequestResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Yapily\Model\ApiResponseOfPaymentAuthorisationRequestResponse',
